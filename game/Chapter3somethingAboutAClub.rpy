label Akari3:
    ...
    Yukiko smile vhappy p2 "Well! If you're hungry, you can have a few bites of {i}my{/i} rice. Just to get you by!"
    ...
    #timeskip
    play music frozendream fadein 1
